...
1. **JavaScript API tests.**
   ...
   emcmake cmake -S wasm/tests -B wasm/tests/build && \
   cmake --build wasm/tests/build && \
   python3 -m wasm.tests.enums_test_generator && \
